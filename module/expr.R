               ...
               fluidRow(
                 ...
                 box(width = 3,status="success",
                     ...
                     dropdownButton(circle=FALSE, label=lang$t("参考数据"), status="success",icon = icon("download"),
                                    ...
                                    downloadBttn(ns("downloadGroup"), lang$t("分组"), size='sm', block=TRUE) ),br(),
                 ...
                 box(width = 3,status="success",
                     ...
                     dropdownButton(circle=FALSE, label=lang$t("图形标签"), icon = icon("image"),
                                    ...
                                    selectInput(ns('theme'),lang$t('主题'),selected = 'bw',
                                                choices =c('bw','classic','classic','linedraw','cleveland',
                                                           'dark','light','get','replace', 'gray','grey',
                                                           'minimal','pubclean','void','test',
                                                           'update','transparent') )
                     ),br(),
